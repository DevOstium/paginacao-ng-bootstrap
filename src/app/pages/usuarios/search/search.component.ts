       ...
       // this.debounce.subscribe(value => alert(value)); // aqui vou receber o dado: valor a ser passado
        ...
        this.debounce
                    .pipe( debounceTime(300) )  // 300 milisegundos
                                               ...
                                               // .pipe( tap( filtro => console.log("Http: " + filtro) ) )  

                                              .subscribe( filter => {
                                                                      console.log("enviar o dado para o usuario.controller: " + filter);
                                                                      this.onTyping.emit(filter); 
                                                });  // cuidado com o Memory Leak
                                              //.subscribe( filter => console.log(filter) );  // cuidado com o Memory Leak
    }    
